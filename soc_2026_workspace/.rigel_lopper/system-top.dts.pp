#line 1 "../platform_can_2/hw/sdt/system-top.dts"
/dts-v1/;
#line 1 "../platform_can_2/hw/sdt/pl.dtsi"
/ {
	...
	amba_pl: amba_pl {
		...
		myip_can_modified_0: myip_can_modified@44a00000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-can-modified-1.0";
			status = "okay";
			xlnx,s00-axi-addr-width = <5>;
			xlnx,ip-name = "myip_can_modified";
			xlnx,edk-iptype = "PERIPHERAL";
			reg = <0x44a00000 0x10000>;
			xlnx,name = "myip_can_modified_0";
		};
		myip_can_modified_1: myip_can_modified@44a10000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-can-modified-1.0";
			status = "okay";
			...
			xlnx,name = "myip_can_modified_1";
		};
	};
};
#line 3 "../platform_can_2/hw/sdt/system-top.dts"
/ {
	board = "basys3";
	...
	cpus_microblaze_riscv_0: cpus_microblaze_riscv@0 {
		address-map = <0x00000000 &microblaze_riscv_0_local_memory_dlmb_bram_if_cntlr_memory 0x00000000 0x20000>,
			      ...
			      <0x44a00000 &myip_can_modified_0 0x44a00000 0x10000>,
			      <0x44a10000 &myip_can_modified_1 0x44a10000 0x10000>;
