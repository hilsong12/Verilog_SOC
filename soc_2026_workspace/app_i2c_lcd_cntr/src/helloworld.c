...
#define iic_cntr_addr XPAR_MYIP_IIC_CNTR_0_BASEADDR

// volatile 키워드 필수! (컴파일러 최적화 방지)
volatile unsigned int *lcd_ip_base = (unsigned int *)XPAR_MYIP_IIC_CNTR_0_BASEADDR;
...
int main()
{
    ...
    char *msg1 = "Hello FPGA";
    char *msg2 = "Don't Panic!";
