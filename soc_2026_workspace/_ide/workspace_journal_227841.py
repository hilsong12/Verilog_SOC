# 2026-01-26T11:28:10.133505
import vitis

client = vitis.create_client()
client.set_workspace(path="soc_2026_workspace")

client.delete_component(name="app_cooktimer_re")

client.delete_component(name="platform_cooktimer_re")
...
client.delete_component(name="app_cooktimer")

client.delete_component(name="platform_cooktimer")
