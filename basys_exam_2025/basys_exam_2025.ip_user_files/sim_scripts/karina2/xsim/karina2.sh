...
#
# Script generated by Vivado on Fri Jan 16 13:54:09 KST 2026
...
#
# Usage        : karina2.sh
#                karina2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                karina2.sh [-reset_run]
#                karina2.sh [-reset_log]
#                karina2.sh [-help]
#
...
# script info
echo -e "karina2.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./karina2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot karina2 xil_defaultlib.karina2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim karina2 -key {Behavioral:sim_1:Functional:karina2} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb karina2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./karina2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: karina2.sh [-help]\n\
Usage: karina2.sh [-step]\n\
Usage: karina2.sh [-lib_map_path]\n\
Usage: karina2.sh [-reset_run]\n\
Usage: karina2.sh [-reset_log]\n\
Usage: karina2.sh [-keep_index]\n\
Usage: karina2.sh [-noclean_files]\n\n\
