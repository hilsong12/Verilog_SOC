...
#                script (type 'adc_2ch_sequence.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.adc_2ch_sequence xil_defaultlib.glbl -o adc_2ch_sequence_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./adc_2ch_sequence_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/user12/data/work/basys_exam_2025/basys_exam_2025.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key adc_2ch_sequence_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc adc_2ch_sequence_simv.daidir vcs_lib c.obj)
