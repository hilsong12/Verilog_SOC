...
#
# Script generated by Vivado on Tue Dec 16 12:21:22 KST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : adc_2ch_sequence.sh
...
#
# Usage        : adc_2ch_sequence.sh
#                adc_2ch_sequence.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                adc_2ch_sequence.sh [-reset_run]
#                adc_2ch_sequence.sh [-reset_log]
#                adc_2ch_sequence.sh [-help]
#
...
# script info
echo -e "adc_2ch_sequence.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./adc_2ch_sequence.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot adc_2ch_sequence xil_defaultlib.adc_2ch_sequence xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim adc_2ch_sequence -key {Behavioral:sim_1:Functional:adc_2ch_sequence} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb adc_2ch_sequence.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./adc_2ch_sequence.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: adc_2ch_sequence.sh [-help]\n\
Usage: adc_2ch_sequence.sh [-step]\n\
Usage: adc_2ch_sequence.sh [-lib_map_path]\n\
Usage: adc_2ch_sequence.sh [-reset_run]\n\
Usage: adc_2ch_sequence.sh [-reset_log]\n\
Usage: adc_2ch_sequence.sh [-keep_index]\n\
Usage: adc_2ch_sequence.sh [-noclean_files]\n\n\
