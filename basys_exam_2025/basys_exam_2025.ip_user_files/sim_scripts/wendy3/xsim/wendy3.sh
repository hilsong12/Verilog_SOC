...
#
# Script generated by Vivado on Fri Jan 16 14:30:08 KST 2026
...
#
# Usage        : wendy3.sh
#                wendy3.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                wendy3.sh [-reset_run]
#                wendy3.sh [-reset_log]
#                wendy3.sh [-help]
#
...
# script info
echo -e "wendy3.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./wendy3.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot wendy3 xil_defaultlib.wendy3 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim wendy3 -key {Behavioral:sim_1:Functional:wendy3} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb wendy3.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./wendy3.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: wendy3.sh [-help]\n\
Usage: wendy3.sh [-step]\n\
Usage: wendy3.sh [-lib_map_path]\n\
Usage: wendy3.sh [-reset_run]\n\
Usage: wendy3.sh [-reset_log]\n\
Usage: wendy3.sh [-keep_index]\n\
Usage: wendy3.sh [-noclean_files]\n\n\
