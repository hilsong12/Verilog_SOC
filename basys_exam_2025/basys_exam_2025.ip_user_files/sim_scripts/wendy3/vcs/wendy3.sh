...
#                script (type 'wendy3.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.wendy3 xil_defaultlib.glbl -o wendy3_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./wendy3_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key wendy3_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc wendy3_simv.daidir vcs_lib c.obj)
