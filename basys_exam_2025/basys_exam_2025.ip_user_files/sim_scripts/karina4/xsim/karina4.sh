...
#
# Script generated by Vivado on Fri Jan 16 14:15:56 KST 2026
...
#
# Usage        : karina4.sh
#                karina4.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                karina4.sh [-reset_run]
#                karina4.sh [-reset_log]
#                karina4.sh [-help]
#
...
# script info
echo -e "karina4.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./karina4.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot karina4 xil_defaultlib.karina4 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim karina4 -key {Behavioral:sim_1:Functional:karina4} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb karina4.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./karina4.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: karina4.sh [-help]\n\
Usage: karina4.sh [-step]\n\
Usage: karina4.sh [-lib_map_path]\n\
Usage: karina4.sh [-reset_run]\n\
Usage: karina4.sh [-reset_log]\n\
Usage: karina4.sh [-keep_index]\n\
Usage: karina4.sh [-noclean_files]\n\n\
