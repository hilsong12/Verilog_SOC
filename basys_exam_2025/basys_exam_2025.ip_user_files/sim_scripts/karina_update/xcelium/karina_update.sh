...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.karina_update xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.karina_update -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/user12/data/work/basys_exam_2025/basys_exam_2025.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log karina_update_sc.so .tmp_log xcelium_lib waves.shm c.obj)
