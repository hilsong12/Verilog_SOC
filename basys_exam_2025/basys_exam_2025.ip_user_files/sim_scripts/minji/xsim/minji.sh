...
#
# Script generated by Vivado on Fri Jan 16 12:51:41 KST 2026
...
#
# Usage        : minji.sh
#                minji.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                minji.sh [-reset_run]
#                minji.sh [-reset_log]
#                minji.sh [-help]
#
...
# script info
echo -e "minji.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./minji.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot minji xil_defaultlib.minji xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim minji -key {Behavioral:sim_1:Functional:minji} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb minji.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./minji.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: minji.sh [-help]\n\
Usage: minji.sh [-step]\n\
Usage: minji.sh [-lib_map_path]\n\
Usage: minji.sh [-reset_run]\n\
Usage: minji.sh [-reset_log]\n\
Usage: minji.sh [-keep_index]\n\
Usage: minji.sh [-noclean_files]\n\n\
