...
#
# Script generated by Vivado on Fri Jan 16 15:06:54 KST 2026
...
#
# Usage        : combine.sh
#                combine.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                combine.sh [-reset_run]
#                combine.sh [-reset_log]
#                combine.sh [-help]
#
...
# script info
echo -e "combine.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./combine.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot combine xil_defaultlib.combine xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim combine -key {Behavioral:sim_1:Functional:combine} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb combine.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./combine.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: combine.sh [-help]\n\
Usage: combine.sh [-step]\n\
Usage: combine.sh [-lib_map_path]\n\
Usage: combine.sh [-reset_run]\n\
Usage: combine.sh [-reset_log]\n\
Usage: combine.sh [-keep_index]\n\
Usage: combine.sh [-noclean_files]\n\n\
