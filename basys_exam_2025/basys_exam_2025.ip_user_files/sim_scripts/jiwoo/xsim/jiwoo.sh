...
#
# Script generated by Vivado on Fri Jan 16 15:57:27 KST 2026
...
#
# Usage        : jiwoo.sh
#                jiwoo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                jiwoo.sh [-reset_run]
#                jiwoo.sh [-reset_log]
#                jiwoo.sh [-help]
#
...
# script info
echo -e "jiwoo.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./jiwoo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot jiwoo xil_defaultlib.jiwoo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim jiwoo -key {Behavioral:sim_1:Functional:jiwoo} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb jiwoo.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./jiwoo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: jiwoo.sh [-help]\n\
Usage: jiwoo.sh [-step]\n\
Usage: jiwoo.sh [-lib_map_path]\n\
Usage: jiwoo.sh [-reset_run]\n\
Usage: jiwoo.sh [-reset_log]\n\
Usage: jiwoo.sh [-keep_index]\n\
Usage: jiwoo.sh [-noclean_files]\n\n\
