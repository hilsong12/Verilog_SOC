...
#
# Script generated by Vivado on Fri Jan 16 15:11:39 KST 2026
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : wendy_karina.sh
...
#
# Usage        : wendy_karina.sh
#                wendy_karina.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                wendy_karina.sh [-reset_run]
#                wendy_karina.sh [-reset_log]
#                wendy_karina.sh [-help]
#
...
# script info
echo -e "wendy_karina.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./wendy_karina.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot wendy_karina xil_defaultlib.wendy_karina xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim wendy_karina -key {Behavioral:sim_1:Functional:wendy_karina} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb wendy_karina.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./wendy_karina.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: wendy_karina.sh [-help]\n\
Usage: wendy_karina.sh [-step]\n\
Usage: wendy_karina.sh [-lib_map_path]\n\
Usage: wendy_karina.sh [-reset_run]\n\
Usage: wendy_karina.sh [-reset_log]\n\
Usage: wendy_karina.sh [-keep_index]\n\
Usage: wendy_karina.sh [-noclean_files]\n\n\
