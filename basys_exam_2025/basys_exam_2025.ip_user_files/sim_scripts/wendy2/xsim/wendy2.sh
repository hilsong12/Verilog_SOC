...
#
# Script generated by Vivado on Fri Jan 16 14:26:17 KST 2026
...
#
# Usage        : wendy2.sh
#                wendy2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                wendy2.sh [-reset_run]
#                wendy2.sh [-reset_log]
#                wendy2.sh [-help]
#
...
# script info
echo -e "wendy2.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./wendy2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot wendy2 xil_defaultlib.wendy2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim wendy2 -key {Behavioral:sim_1:Functional:wendy2} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb wendy2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./wendy2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: wendy2.sh [-help]\n\
Usage: wendy2.sh [-step]\n\
Usage: wendy2.sh [-lib_map_path]\n\
Usage: wendy2.sh [-reset_run]\n\
Usage: wendy2.sh [-reset_log]\n\
Usage: wendy2.sh [-keep_index]\n\
Usage: wendy2.sh [-noclean_files]\n\n\
