...
module soc_fnd_cntr
  ...
  soc_fnd_cntr_axi_uartlite_0_1 axi_uartlite_0
       (.rx(usb_uart_rxd),
        ...
        .tx(usb_uart_txd));
  soc_fnd_cntr_clk_wiz_1 clk_wiz
       (.clk_in1(sys_clock),
  ...
  soc_fnd_cntr_myip_fnd_cntr_0_0 myip_fnd_cntr_0
       (.com(com_0),
        ...
        .seg(seg_0));
  soc_fnd_cntr_proc_sys_reset_0_1 proc_sys_reset_0
       (.aux_reset_in(1'b1),
