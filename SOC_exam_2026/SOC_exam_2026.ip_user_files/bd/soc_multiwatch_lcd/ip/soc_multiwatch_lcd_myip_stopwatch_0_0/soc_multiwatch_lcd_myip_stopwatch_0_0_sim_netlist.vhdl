...
--               /media/user12/data/work/SOC_exam_2026/SOC_exam_2026.gen/sources_1/bd/soc_multiwatch_lcd/ip/soc_multiwatch_lcd_myip_stopwatch_0_0/soc_multiwatch_lcd_myip_stopwatch_0_0_sim_netlist.vhdl
...
entity soc_multiwatch_lcd_myip_stopwatch_0_0_edge_detector_n is
  port (
  ...
  attribute ORIG_REF_NAME of soc_multiwatch_lcd_myip_stopwatch_0_0_edge_detector_n : entity is "edge_detector_n";
end soc_multiwatch_lcd_myip_stopwatch_0_0_edge_detector_n;

architecture STRUCTURE of soc_multiwatch_lcd_myip_stopwatch_0_0_edge_detector_n is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity soc_multiwatch_lcd_myip_stopwatch_0_0_edge_detector_n_0 is
  port (
    p_0_in : out STD_LOGIC_VECTOR ( 1 downto 0 );
    Q : in STD_LOGIC_VECTOR ( 0 to 0 );
    s00_axi_aclk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of soc_multiwatch_lcd_myip_stopwatch_0_0_edge_detector_n_0 : entity is "edge_detector_n";
end soc_multiwatch_lcd_myip_stopwatch_0_0_edge_detector_n_0;

architecture STRUCTURE of soc_multiwatch_lcd_myip_stopwatch_0_0_edge_detector_n_0 is
  signal \^p_0_in\ : STD_LOGIC_VECTOR ( 1 downto 0 );
begin
  p_0_in(1 downto 0) <= \^p_0_in\(1 downto 0);
ff_cur_reg: unisim.vcomponents.FDCE
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity soc_multiwatch_lcd_myip_stopwatch_0_0_edge_detector_n_1 is
  port (
    ff_old_reg_0 : out STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 0 to 0 );
    s00_axi_aclk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of soc_multiwatch_lcd_myip_stopwatch_0_0_edge_detector_n_1 : entity is "edge_detector_n";
end soc_multiwatch_lcd_myip_stopwatch_0_0_edge_detector_n_1;

architecture STRUCTURE of soc_multiwatch_lcd_myip_stopwatch_0_0_edge_detector_n_1 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity soc_multiwatch_lcd_myip_stopwatch_0_0_stop_watch is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of soc_multiwatch_lcd_myip_stopwatch_0_0_stop_watch : entity is "stop_watch";
end soc_multiwatch_lcd_myip_stopwatch_0_0_stop_watch;

architecture STRUCTURE of soc_multiwatch_lcd_myip_stopwatch_0_0_stop_watch is
...
ed_clear: entity work.soc_multiwatch_lcd_myip_stopwatch_0_0_edge_detector_n
     port map (
      AR(0) => \^sr\(0),
...
ed_lap: entity work.soc_multiwatch_lcd_myip_stopwatch_0_0_edge_detector_n_0
     port map (
      AR(0) => \^sr\(0),
      Q(0) => Q(1),
...
ed_start: entity work.soc_multiwatch_lcd_myip_stopwatch_0_0_edge_detector_n_1
     port map (
      AR(0) => \^sr\(0),
      Q(0) => Q(0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity soc_multiwatch_lcd_myip_stopwatch_0_0_myip_stopwatch_slave_lite_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of soc_multiwatch_lcd_myip_stopwatch_0_0_myip_stopwatch_slave_lite_v1_0_S00_AXI : entity is "myip_stopwatch_slave_lite_v1_0_S00_AXI";
end soc_multiwatch_lcd_myip_stopwatch_0_0_myip_stopwatch_slave_lite_v1_0_S00_AXI;

architecture STRUCTURE of soc_multiwatch_lcd_myip_stopwatch_0_0_myip_stopwatch_slave_lite_v1_0_S00_AXI is
...
nolabel_line354: entity work.soc_multiwatch_lcd_myip_stopwatch_0_0_stop_watch
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity soc_multiwatch_lcd_myip_stopwatch_0_0_myip_stopwatch is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of soc_multiwatch_lcd_myip_stopwatch_0_0_myip_stopwatch : entity is "myip_stopwatch";
end soc_multiwatch_lcd_myip_stopwatch_0_0_myip_stopwatch;

architecture STRUCTURE of soc_multiwatch_lcd_myip_stopwatch_0_0_myip_stopwatch is
begin
myip_stopwatch_slave_lite_v1_0_S00_AXI_inst: entity work.soc_multiwatch_lcd_myip_stopwatch_0_0_myip_stopwatch_slave_lite_v1_0_S00_AXI
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity soc_multiwatch_lcd_myip_stopwatch_0_0 is
  port (
  ...
  attribute NotValidForBitStream of soc_multiwatch_lcd_myip_stopwatch_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of soc_multiwatch_lcd_myip_stopwatch_0_0 : entity is "soc_multiwatch_lcd_myip_stopwatch_0_0,myip_stopwatch,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of soc_multiwatch_lcd_myip_stopwatch_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of soc_multiwatch_lcd_myip_stopwatch_0_0 : entity is "myip_stopwatch,Vivado 2024.2";
end soc_multiwatch_lcd_myip_stopwatch_0_0;

architecture STRUCTURE of soc_multiwatch_lcd_myip_stopwatch_0_0 is
...
inst: entity work.soc_multiwatch_lcd_myip_stopwatch_0_0_myip_stopwatch
     port map (
