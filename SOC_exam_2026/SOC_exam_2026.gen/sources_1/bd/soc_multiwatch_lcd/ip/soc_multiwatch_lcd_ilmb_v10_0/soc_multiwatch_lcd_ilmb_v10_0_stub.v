...
// Command     : write_verilog -force -mode synth_stub -rename_top soc_multiwatch_lcd_ilmb_v10_0 -prefix
//               soc_multiwatch_lcd_ilmb_v10_0_ soc_hello_ilmb_v10_1_stub.v
...
(* CHECK_LICENSE_TYPE = "soc_hello_ilmb_v10_1,lmb_v10,{}" *) (* core_generation_info = "soc_hello_ilmb_v10_1,lmb_v10,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=lmb_v10,x_ipVersion=3.0,x_ipCoreRevision=14,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_LMB_NUM_SLAVES=1,C_LMB_DWIDTH=32,C_LMB_AWIDTH=32,C_LMB_PROTOCOL=0,C_EXT_RESET_HIGH=1}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "lmb_v10,Vivado 2024.2" *) 
module soc_multiwatch_lcd_ilmb_v10_0(LMB_Clk, SYS_Rst, LMB_Rst, M_ABus, M_ReadStrobe, 
