...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-89315-user12-B80KV-AP35BKE/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      ...
      rt::read_vhdl -lib xil_defaultlib /media/user12/data/work/SOC_exam_2026/SOC_exam_2026.gen/sources_1/bd/soc_multiwatch_lcd/ip/soc_multiwatch_lcd_lmb_bram_0/synth/soc_multiwatch_lcd_lmb_bram_0.vhd
      rt::filesetChecksum
    }
    rt::set_parameter usePostFindUniquification false
    set rt::top soc_multiwatch_lcd_lmb_bram_0
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-89315-user12-B80KV-AP35BKE/"
